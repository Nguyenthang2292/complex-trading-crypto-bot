...
class TestHMMHighOrder(unittest.TestCase):
    ...
    def test_hmm_high_order_model_creation_error(self):
        ...
        with patch('signals._quant_models.hmm_high_order.create_hmm_model') as mock_create:
    ...
    def test_hmm_high_order_invalid_converted_distance(self):
        ...
        with patch('signals._quant_models.hmm_high_order.average_swing_distance') as mock_distance:
