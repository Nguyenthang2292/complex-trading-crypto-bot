...
from signals.best_performance_pairs.BestPerformanceSymbols__class__PerformanceAnalyzer import PerformanceAnalyzer
...
class TestMainFunction(unittest.TestCase):
    ...
    @patch('signals.best_performance_pairs.signals_best_performance_symbols.logger')
    ...
    def test_signal_best_performance_pairs_missing_preloaded_data(self):
        ...
        with patch('signals.best_performance_pairs.signals_best_performance_symbols.logger') as mock_logger:
            result = signal_best_performance_symbols(
                processor=self.mock_processor,
                preloaded_data=None
            )
...
class TestAnalyzeTimeframePerformance(unittest.TestCase):
    ...
    @patch('signals.best_performance_pairs.signals_best_performance_symbols.logger')
    @patch('signals.best_performance_pairs.signals_best_performance_symbols.tqdm')
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_prepare_symbols_stablecoin_filtering(self, mock_logger):
        # Should exclude USDCUSDT and BUSDUSDT
        from signals.best_performance_pairs.signals_best_performance_symbols import _prepare_symbols
    ...
    def test_signal_best_performance_symbols_missing_preloaded_data(self, mock_logger):
        from signals.best_performance_pairs.signals_best_performance_symbols import signal_best_performance_symbols
        result = signal_best_performance_symbols(
            processor=self.mock_processor,
            preloaded_data=None
        )
...
class TestSafeDictAccessAndEmptyCases(unittest.TestCase):
    def test_create_result_dict_handles_missing_keys(self):
        ...
        from signals.best_performance_pairs.signals_best_performance_symbols import _create_result_dict
        best_performers = [{}]
        worst_performers = [{}]
        result = _create_result_dict(
    ...
    def test_select_performers_empty(self):
        ...
        from signals.best_performance_pairs.signals_best_performance_symbols import _select_performers
    ...
    def test_calculate_timeframe_statistics_empty(self):
        ...
        from signals.best_performance_pairs.signals_best_performance_symbols import _calculate_timeframe_statistics
        stats = _calculate_timeframe_statistics([], True)
        self.assertEqual(stats['symbols_processed'], 0)
        self.assertEqual(stats['avg_score'], 0)
        self.assertEqual(stats['median_score'], 0)
...
class TestLoggingAndUtilityFunctions(unittest.TestCase):
    ...
    def test_logging_performance_summary(self, mock_logger):
        from signals.best_performance_pairs.signals_best_performance_symbols import logging_performance_summary
        logging_performance_summary(self.analysis_result)
    ...
    def test_get_top_performers_by_timeframe(self):
        from signals.best_performance_pairs.signals_best_performance_symbols import get_top_performers_by_timeframe
    ...
    def test_get_worst_performers_by_timeframe(self):
        from signals.best_performance_pairs.signals_best_performance_symbols import get_worst_performers_by_timeframe
        worst_performers = get_worst_performers_by_timeframe(self.analysis_result, '1h', top_n=1)
        self.assertEqual(len(worst_performers), 1)
        self.assertEqual(worst_performers[0]['symbol'], 'ADAUSDT')

    def test_get_short_signal_candidates(self):
        from signals.best_performance_pairs.signals_best_performance_symbols import get_short_signal_candidates
        # Add timeframe_scores to worst_performers for testing
...
class TestPrivateHelpersAndEdgeCases(unittest.TestCase):
    ...
    def test_log_timeframe_stats(self, mock_logger):
        from signals.best_performance_pairs.signals_best_performance_symbols import _log_timeframe_stats
        stats = {
            'processed': 10,
            'no_timeframe': 2,
            'insufficient_data': 3,
...
class TestSpecialEdgeCases(unittest.TestCase):
    def test_calculate_timeframe_statistics_missing_keys(self):
        ...
        symbol_metrics = [
            {'symbol': 'BTCUSDT', 'composite_score': 0.8},  # missing composite_score, etc.
