...
from typing import Tuple, Literal, Optional, NamedTuple
import pandas as pd
import ray

from signals._components.HMM__class__OptimizingParameters import OptimizingParameters, HMMKamaResult, HMMHighOrderResult
...
def hmm_signals(
    ...
    signal_high_order_hmm, probability = _get_high_order_hmm_signal(high_order_hmm_result)
    signal_hmm_kama = _get_hmm_kama_signal(hmm_kama_result)
